...
def verify(otp_session, otp_code):
    ...
    if response_verify.status_code == 201:
        ...
        print("> Verification request failed with status code:", response_verify.status_code)
...
def index():
    if request.method == 'POST':
        ...
        return render_template('index.html', message='Invalid phone number. Check formatting and Please try again.')
